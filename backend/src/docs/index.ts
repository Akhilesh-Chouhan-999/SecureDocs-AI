...
export const routeCatalog = [
  ...
  },
  {
    ...
    group: "auth",
    auth: false,
    purpose: "Create analyst account",
  },
  {
    method: "POST",
    path: "/api/auth/login",
  ...
  },
  {
    ...
    group: "auth",
    auth: true,
    purpose: "Invalidate current session client-side",
  },
  {
    method: "GET",
  ...
  },
  {
    ...
    group: "analysis",
    auth: true,
    purpose: "Run OCR and fraud checks",
  },
  {
    method: "POST",
    path: "/api/analysis/ocr",
    group: "analysis",
    auth: true,
    purpose: "Run OCR only",
  },
  {
    method: "POST",
    ...
    group: "analysis",
    auth: true,
    purpose: "Detect anomalies from stored OCR",
  },
  {
    method: "POST",
    path: "/api/analysis/risk-score",
    group: "analysis",
    auth: true,
    purpose: "Calculate document risk score",
  },
  {
    method: "GET",
    path: "/api/analysis/status/:documentId",
    group: "analysis",
    auth: true,
    purpose: "Get analysis status by document",
  },
  {
    method: "GET",
    path: "/api/analysis/results/:documentId",
    group: "analysis",
    auth: true,
    purpose: "Get analysis results by document",
  },
  {
    method: "GET",
    path: "/api/history",
    group: "history",
    auth: true,
    purpose: "Search historical context records",
  },
  {
    method: "GET",
    path: "/api/history/:email",
    group: "history",
    auth: true,
    purpose: "Fetch historical context by email",
  },
  {
    method: "POST",
  ...
  },
  {
    ...
    group: "reports",
    auth: true,
    purpose: "List current user reports",
  },
  {
    method: "GET",
    ...
    group: "reports",
    auth: true,
    purpose: "List reports for a user",
  },
  {
    method: "GET",
  ...
  },
  {
    ...
    group: "reports",
    auth: true,
    purpose: "Review and decide on a fraud report",
  },
  {
    method: "DELETE",
    path: "/api/reports/:reportId",
  ...
  },
  {
    ...
    group: "jobs",
    auth: true,
    purpose: "List current user jobs",
  },
  {
    method: "POST",
    path: "/api/jobs/analysis",
    group: "jobs",
    auth: true,
    purpose: "Queue analysis work",
  },
  {
    method: "GET",
  ...
  },
  {
    ...
    group: "jobs",
    auth: true,
    purpose: "Cancel queued analysis work",
  },
  {
    method: "POST",
    ...
    group: "jobs",
    auth: true,
    purpose: "Retry a failed or canceled job",
  },
];
...
export const folderUsage = {
  ...
  controllers:
    "Thin HTTP layer for auth, documents, analysis, reports, and jobs.",
  services:
    "Business logic for auth, document lifecycle, analysis, reporting, and jobs.",
  repositories: "Mongoose-backed persistence helpers.",
  middleware: "Auth, validation, upload handling, and global errors.",
  errors:
    "Custom operational errors including AppError, AuthError, NotFoundError, and ValidationError.",
  ...
  infrastructure:
    "Storage, queue worker helpers, AI tools, database models, and cache glue.",
