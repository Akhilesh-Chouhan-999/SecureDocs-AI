...
import { authMiddleware, uploadMiddleware, validate } from "../middleware/index.js";
import { documentValidators } from "../validators/index.js";

const router = Router();

router.post("/upload", authMiddleware, uploadMiddleware.single("document"), DocumentController.uploadDocument);
